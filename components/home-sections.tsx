    ...
    <div className="container about-container">
      <div className="about-main-grid">
        <div className="about-content-col reveal">
          ...
          <h2 className="about-headline">O <span className="headline-highlight-italic">Grupo Mais Barato</span> reúne negócios<br />que fazem parte do dia a dia<br />das pessoas de <span style={{ whiteSpace: 'nowrap' }}>Belém — PA</span></h2>
